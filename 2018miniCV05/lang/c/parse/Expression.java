...
public class Expression extends CParseRule {
	...
	public void parse(CParseContext pcx) throws FatalErrorException {
		//System.out.println("expressionにきてるよ");
...
class ExpressionSub extends CParseRule {
	...
	public void semanticCheck(CParseContext pcx) throws FatalErrorException {
		...
		//	R	T_err			T_int						T_pint				T_intarray		T_pintarray			L
			...
			{	CType.T_err,	CType.T_err,		CType.T_int,		CType.T_err,	CType.T_err	},		//T_intarray
			{	CType.T_err, 	CType.T_err,		CType.T_int,		CType.T_err,	CType.T_err	},		//T_pintarray
		};
		int lt = 0, rt = 0;
		boolean lc = false, rc = false;
		if (left != null) {
